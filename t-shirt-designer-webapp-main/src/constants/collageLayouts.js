...
export const COLLAGE_LAYOUTS = [
  ...
  { id: "2v-60", label: "2 поруч 60/40", cols: 2,
    slots: [{ x: 0, y: 0, w: 0.6, h: 1 }, { x: 0.6, y: 0, w: 0.4, h: 1 }] },
  { id: "2v-40", label: "2 поруч 40/60", cols: 2,
    slots: [{ x: 0, y: 0, w: 0.4, h: 1 }, { x: 0.4, y: 0, w: 0.6, h: 1 }] },
  { id: "2h-60", label: "2 стовпч. 60/40", cols: 1,
    slots: [{ x: 0, y: 0, w: 1, h: 0.6 }, { x: 0, y: 0.6, w: 1, h: 0.4 }] },
  { id: "2h-big-top", label: "Велике + смужка", cols: 1,
    slots: [{ x: 0, y: 0, w: 1, h: 2 * T }, { x: 0, y: 2 * T, w: 1, h: T }] },
  ...
  { id: "1+2-60", label: "Велике зліва + 2", cols: 2,
    slots: [{ x: 0, y: 0, w: 0.6, h: 1 }, { x: 0.6, y: 0, w: 0.4, h: 0.5 }, { x: 0.6, y: 0.5, w: 0.4, h: 0.5 }] },
  { id: "2+1-60", label: "2 + велике справа", cols: 2,
    slots: [{ x: 0, y: 0, w: 0.4, h: 0.5 }, { x: 0, y: 0.5, w: 0.4, h: 0.5 }, { x: 0.4, y: 0, w: 0.6, h: 1 }] },
  { id: "1-2-60", label: "Велике зверху + 2", cols: 2,
    slots: [{ x: 0, y: 0, w: 1, h: 0.6 }, { x: 0, y: 0.6, w: 0.5, h: 0.4 }, { x: 0.5, y: 0.6, w: 0.5, h: 0.4 }] },
  { id: "2-1-60", label: "2 + велике знизу", cols: 2,
    slots: [{ x: 0, y: 0, w: 0.5, h: 0.4 }, { x: 0.5, y: 0, w: 0.5, h: 0.4 }, { x: 0, y: 0.4, w: 1, h: 0.6 }] },
  { id: "1L+2R-uneven", label: "Велике + 2 різні", cols: 2,
    slots: [{ x: 0, y: 0, w: 0.5, h: 1 }, { x: 0.5, y: 0, w: 0.5, h: 0.62 }, { x: 0.5, y: 0.62, w: 0.5, h: 0.38 }] },
