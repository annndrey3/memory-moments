...
// BASE_URL: "/" у dev, "/designer/" у prod — щоб ассети грузились з правильного шляху.
const TSHIRT_GLB = `${import.meta.env.BASE_URL}3Dmodels/02.glb`;
const FALLBACK_TEXTURE = `${import.meta.env.BASE_URL}3Dmodels/textures/design-fallback.png`;
...
export function TshirtModel({
  ...
  const { nodes, materials } = useGLTF(TSHIRT_GLB);
  const texture = useTexture(designTexture || FALLBACK_TEXTURE);
  const textureBack = useTexture(designTextureBack || FALLBACK_TEXTURE);
