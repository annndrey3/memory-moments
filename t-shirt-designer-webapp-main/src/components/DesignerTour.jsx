...
const STEPS = [
  ...
  },
  {
    sel: '[title="Шари"]',
    title: "5. Шари",
    text: "Усі обʼєкти макета — тут. Клікніть шар, щоб зробити його активним: рухати, масштабувати й змінювати на макеті можна ЛИШЕ активний шар. Шари можна ховати 👁, міняти порядок ↑↓ і видаляти.",
  },
  {
    sel: '[data-tour="order"]',
    title: "6. Оформіть замовлення",
