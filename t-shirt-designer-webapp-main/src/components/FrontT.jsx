...
const FRONT_GLB = `${import.meta.env.BASE_URL}3Dmodels/front.glb`;
const FALLBACK_TEXTURE = `${import.meta.env.BASE_URL}2.webp`;

export function FrontT({ tshirtColor, designTexture, onViewChange }) {
  const texture = useTexture(designTexture || FALLBACK_TEXTURE);
  const { nodes, materials } = useGLTF(FRONT_GLB);
